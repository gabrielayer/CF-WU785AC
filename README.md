...
```Nota: Se o seu roteador tiver uma porta USB e for compatível com OpenWRT, você poderá usar
adaptadores baseados no mt7612u para adicionar outra rede de 2,4 GHz ou 5 GHz.
Isso funciona bem.```
